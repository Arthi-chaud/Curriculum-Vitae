...
\resumeItemListStart
\resumeItem{\normalsize{\textit{Type-safe and portable support for packed data} - \textbf{A. Jamet}, M.Vollmer (ECOOP 2025)}} \href{https://arxiv.org/abs/2504.20166}{\color{blue}\underline{Link}}
% \vspace{-5pt}
