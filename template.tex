...
\resumeItem{\normalsize{\textit{Programmable Record Types for Haskell} - \textbf{A. Jamet}, M.Vollmer (GPCE 2026)}} \href{https://dl.acm.org/doi/10.1145/3814885.3816408}{\color{blue}\underline{Link}}
% \vspace{-5pt}
...
\resumeItem{\normalsize{
		\textbf{Meelo},
		\en{Music Server, designed for collectors. Personal project. Written with Nest (Server), Next (Web app), with Golang and Python for microservices.}
		\fr{Serveur de musique, désigné pour les collectionneurs. Projet personnel. Réalisé avec Nest (Server), Next (App Web), et Golang et Python pour des microservices.}
	}
...
\resumeItem{\normalsize{
		\textbf{FuNes},
		\en{Experimental Nintendo Entertainment System (NES) emulator, powered by the functional paradigm (written in Haskell).}
		\fr{Emulateur experimental pour la Nintendo Entertainment System (NES), basé sur le paradigm fonctionnel (implémenté en Haskell).}
	}
	\href{https://github.com/Arthi-chaud/FuNes}{\color{blue}\underline{github.com/Arthi-chaud/funes}}}
\resumeItemListEnd
