...
\begin{center}
    {\huge Arthur Jamet} \\ \vspace{2pt} 
    \href{mailto:[enter your email id]}{\color{blue}{arthur.jamet@gmail.com}} ~ 
    \small{-}
    \href{[url to linkedin profile]}{ \color{blue}{linkedin.com/in/arthur-jamet}}  ~
    \small{-}
    \href{[url to github profile]}{ \color{blue}{github.com/Arthi-chaud}} ~
    \vspace{-7pt}
\end{center}
...
\section{\color{airforceblue}
  ...
  \resumeSubHeadingListStart
    \resumeSubheading
      ...
      \hspace{\parindent} \hspace{\parindent} GPA: 3.73/4.00
     \resumeSubheading
      {
 ...
 \begin{itemize}[leftmargin=0in, label={}]
    \small{\item{
     \textbf{\normalsize{
      ...
      }}{\normalsize{TypeScript/JavaScript, Haskell, Rust, Dart, Python, PHP, C++}} \\
      \vspace{2.4pt}
      \textbf{\normalsize{
     ...
     \textbf{\normalsize{
      \en{Tools:}
      \fr{Outils:}
      }}{ \normalsize{Bash, Git, GitHub, Docker, LaTeX}} \\
      \vspace{2.4pt}
     }}
 \end{itemize}
 \vspace{-16pt}
 ...
 \fr{PROJETS}
    ...
    \resumeItemListStart
        ...
        \resumeItem{\normalsize{
          ...
          \href{[url to project github repo]}{\color{blue}\underline{github.com/Arthi-chaud/Meelo}}}
        \vspace{-5pt}
        \resumeItem{\normalsize{
          \textbf{AERIS},
